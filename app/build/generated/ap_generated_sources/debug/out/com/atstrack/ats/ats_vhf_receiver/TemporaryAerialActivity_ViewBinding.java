...
public class TemporaryAerialActivity_ViewBinding implements Unbinder {
  private TemporaryAerialActivity target;
  ...
  @UiThread
  public TemporaryAerialActivity_ViewBinding(TemporaryAerialActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public TemporaryAerialActivity_ViewBinding(final TemporaryAerialActivity target, View source) {
    this.target = target;
    ...
    view = Utils.findRequiredView(source, R.id.ready_aerial_scan_button, "method 'onClickReadyToAerialScan'");
    view7f0a01c9 = view;
    view.setOnClickListener(new DebouncingOnClickListener() {
      @Override
      public void doClick(View p0) {
        target.onClickReadyToAerialScan(p0);
      }
    });
  }
  ...
  @CallSuper
  public void unbind() {
    TemporaryAerialActivity target = this.target;
