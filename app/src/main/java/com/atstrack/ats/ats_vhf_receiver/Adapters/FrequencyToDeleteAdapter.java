...
public class FrequencyToDeleteAdapter extends BaseAdapter {
    ...
    public FrequencyToDeleteAdapter(Context context, ArrayList<Integer> frequencies, CheckBox all_frequencies_checkBox, Button delete_selected_frequencies_button) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        cb_frequency_number.setText(String.valueOf(frequencies.get(position)));
