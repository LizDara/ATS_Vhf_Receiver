...
public class TableToMergeAdapter extends BaseAdapter {
    ...
    public TableToMergeAdapter(Context context, ArrayList<Integer> tables, ArrayList<Integer> frequencies, Button merge_tables_button) {
        this.tables = tables;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        cb_frequency_number.setText("Table " + tables.get(position) + " (" + frequencies.get(position) + " frequencies)");
