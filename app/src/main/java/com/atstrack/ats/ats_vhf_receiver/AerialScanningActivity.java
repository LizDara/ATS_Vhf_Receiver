...
public class AerialScanningActivity extends AppCompatActivity {
    ...
    private final static String TAG = AerialScanningActivity.class.getSimpleName();
    ...
    @OnClick(R.id.aerial_scan_defaults_button)
    ...
    @OnClick(R.id.aerial_scan_temporary_button)
    public void onClickAerialScanTemporary(View v) {
        Intent intent = new Intent(this, TemporaryAerialActivity.class);
        startActivity(intent);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aerial_scanning);
