...
public class ConvertRawDataActivity extends AppCompatActivity {
    ...
    private final static String TAG = ConvertRawDataActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_convert_raw_data);
        ButterKnife.bind(this);

        setSupportActionBar(toolbar);
        title_toolbar.setText(R.string.convert_raw_data);
