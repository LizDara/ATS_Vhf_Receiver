...
public class ReceiverOptionsActivity extends AppCompatActivity {
    ...
    private final static String TAG = ReceiverOptionsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_receiver_options);
        ButterKnife.bind(this);

        // Customize the activity menu
        setSupportActionBar(toolbar);
        title_toolbar.setText(R.string.receiver_options);
