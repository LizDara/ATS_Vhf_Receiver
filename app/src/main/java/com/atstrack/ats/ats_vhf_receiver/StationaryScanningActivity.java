...
public class StationaryScanningActivity extends AppCompatActivity {
    ...
    private final static String TAG = StationaryScanningActivity.class.getSimpleName();
    ...
    @OnClick(R.id.stationary_scan_defaults_button)
    ...
    @OnClick(R.id.stationary_scan_temporary_button)
    public void onClickStationaryScanTemporary(View v) {
        Intent intent = new Intent(this, TemporaryStationaryActivity.class);
        startActivity(intent);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stationary_scanning);
