...
public class VhfCloneActivity extends AppCompatActivity {

    private final static String TAG = VhfCloneActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhf_clone);
        ButterKnife.bind(this);
        ActivitySetting.setToolbar(this, R.string.clone_receiver);
