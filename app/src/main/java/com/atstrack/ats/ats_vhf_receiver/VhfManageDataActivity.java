...
public class VhfManageDataActivity extends AppCompatActivity {
    ...
    private final static String TAG = VhfManageDataActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhf_manage_data);
        ButterKnife.bind(this);
        ActivitySetting.setToolbar(this, R.string.manage_receiver_data);
    ...
    private void showDisconnectionMessage(int status) {
        ...
        Message.showDisconnectionMessage(this, status);
    }
    ...
    private void handleSignInIntent(Intent data) {
        GoogleSignIn.getSignedInAccountFromIntent(data).addOnSuccessListener(googleSignInAccount -> {
            GoogleAccountCredential credential = GoogleAccountCredential.usingOAuth2(
                    VhfManageDataActivity.this, Collections.singleton(DriveScopes.DRIVE_FILE));
