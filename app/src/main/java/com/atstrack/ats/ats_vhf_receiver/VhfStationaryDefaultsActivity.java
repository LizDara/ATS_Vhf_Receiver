...
public class VhfStationaryDefaultsActivity extends AppCompatActivity {
    ...
    private final static String TAG = VhfStationaryDefaultsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vhf_stationary_defaults);
        ButterKnife.bind(this);
        ActivitySetting.setToolbar(this, R.string.stationary_defaults);
